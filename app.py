...
@app.route('/venues')
def venues():
    """Establish Venues Listings Page."""
...
def show_venue(venue_id):
    """Establish Individiual Venue Page."""
...
def create_venue_form():
    """Build form for creating new venue."""
    form = VenueForm()
